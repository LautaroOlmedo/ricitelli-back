...
func (UnimplementedCustomerServiceServer) DeactivateCustomer(context.Context, *DeactivateCustomerRequest) (*Customer, error) {
	return nil, status.Error(codes.Unimplemented, "method DeactivateCustomer not implemented")
}
...
func (UnimplementedCustomerServiceServer) GetOrdersByCustomer(context.Context, *GetOrdersByCustomerRequest) (*GetOrdersByCustomerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetOrdersByCustomer not implemented")
}
