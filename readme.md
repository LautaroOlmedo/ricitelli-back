protoc -I=.   -I=../product   -I=../sale-order   -I=../production-order   --go_out=paths=source_relative:../gen/application_service   --go-grpc_out=paths=source_relative:../gen/application_service   application-service.proto
...
protoc   -I=.   -I=../sale-order   -I=../product   --go_out=paths=source_relative:../gen/customer   --go-grpc_out=paths=source_relative:../gen/customer   customer.proto